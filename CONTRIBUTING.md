...
The primary source repository is hosted at [Bitbucket](https://bitbucket.org/isode/gcxp/) and can be checked out using
...
where branch is the appropriate upstream branch (see Branch Flow discussion above). Then attach the patch to a new [issue report](https://bitbucket.org/isode/gcxp/issues).
